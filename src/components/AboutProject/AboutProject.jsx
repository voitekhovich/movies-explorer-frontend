  ...
  return (
    <section className='about-project'>
      ...
      <div className='about-project__timeline'>
        <p className='about-project__timeline-text about-project__timeline-week'>1 неделя</p>
        <p className='about-project__timeline-text about-project__timeline-week'>4 недели</p>
        <p className='about-project__timeline-text about-project__timeline-description'>Back-end</p>
        <p className='about-project__timeline-text about-project__timeline-description'>Front-end</p>
      </div>
    </section>
  );
}
